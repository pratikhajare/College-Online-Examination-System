        ...
        <table id="myTable" class="table table-striped table-bordered dataTables" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><c:choose>
                        <c:when test="${result.resStatus==true}">
                           Pass
                        </c:when>
                        <c:otherwise>
                            Fail
                    ...
                    <td><a href="${pageContext.request.contextPath}/studentpage/queresultpage/${result.result_id}"><button class="btn btn-primary">View Result</button></a></td>
                </tr>
                </c:forEach>
                    </tbody>
        </table>
