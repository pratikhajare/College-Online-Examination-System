        ...
        <table id="myTable" class="table table-striped table-bordered dataTables" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    <td>${exam.examname}</td>
                    <c:set var="examdate">
                    <fmt:formatDate pattern="dd-MM-yyyy" value="${exam.examdate}" />
                    </c:set>
                    <td>${examdate}</td>
                    <c:set var="validdate">
                    <fmt:formatDate pattern="dd-MM-yyyy" value="${exam.dateValid}" />
                    </c:set>
                    <td>${validdate}</td>
                    ...
                    <td><a href="${pageContext.request.contextPath}/teacherpage/addquestion/${exam.exam_id}"><button class="btn btn-primary">Add Question</button></a></td>
                </tr>
                </c:forEach>
                    </tbody>
        </table>
